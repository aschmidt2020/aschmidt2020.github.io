    ...
    return (
        <div className="row">
                <div className="col-5">
                    ...
                    <p className = "about-me-normal">audsch@outlook.com</p>
                    <br></br>
                    ...
                    <p className = "about-me-normal">www.linkedin.com/in/audsch</p>
                    <br></br>
                    ...
                    <p className = "about-me-normal">https://github.com/aschmidt2020</p>
